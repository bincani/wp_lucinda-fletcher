...
function rs_countdown_banner( $atts, $content = '', $id = '' ) {
  ...
  if($year && $month && $days && $hours && $minutes && $seconds) {
    $data_count_date = ' data-finish-date="'.esc_attr($days).'/'.esc_attr($month).'/'.esc_attr($year).' '.esc_attr($hours).':'.esc_attr($minutes).':'.esc_attr($seconds).'"';
  }
  ...
  $output .=  '<li>';
  $output .=  '<span class="countdown-number"><span class="days font-alt">00</span><b class="days_ref">days</b></span>';
  $output .=  '</li>';
  $output .=  '<li>';
  $output .=  '<span class="countdown-number"><span class="hours font-alt">00</span><b class="hours_ref">hours</b></span>';
  $output .=  '</li>';
  $output .=  '<li>';
  $output .=  '<span class="countdown-number"><span class="minutes font-alt">00</span><b class="minutes_ref">minutes</b></span>';
  $output .=  '</li>';
  $output .=  '<li>';
  $output .=  '<span class="countdown-number"><span class="seconds font-alt">00</span><b class="seconds_ref">seconds</b></span>';
  $output .=  '</li>';
  $output .=  '</ul>';
